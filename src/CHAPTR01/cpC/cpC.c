// Disable CRT warnings that prevent compilation.
// WARNING: you should use the suggested secure
// alternatives in production code. These
// warnings are only disabled as this is legacy
// code.
